...
export default function Button({ title, onClick, children }) {
  return (
    <button
      className="group relative inline-flex h-10 items-center justify-center rounded-full bg-primary px-4 py-7 text-sm font-medium text-white transition-colors hover:bg-primary/90"
      onClick={onClick}
    >
