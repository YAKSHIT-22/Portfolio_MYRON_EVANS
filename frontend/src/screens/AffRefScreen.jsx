function AffRefScreen() {
  ...
  return <div className=" flex flex-col text-center items-center">
    ...
    <div className=" flex flex-col items-center rounded-[2rem] bg-secondary">

      <h1 className="text-section-heading">Heres your affiliate link</h1>
      <div className="flex justify-center w-[54rem] rounded-[1rem] shadow-2xl" style={{ border: '0.5px rgba(238, 238, 238, 0.3)', backgroundColor: 'rgba(32, 31, 31, 0.4)' }}> refferal link <span>copy</span></div>
      <div className=" text-center flex flex-col justify-center items-center w-[54rem] h-[34rem] rounded-[2rem] bg-sm-primary mb-20 m-20">
