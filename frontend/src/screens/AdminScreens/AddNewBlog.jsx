          ...
          <div className="">
            ...
            <div className="flex flex-row flex-wrap gap-8">
              <div
                ...
                id="Box1"
              >
                <h1 className="py-4 text-box-heading" aria-label="Top-Right">
                  Top Right{' '}
                </h1>
                <img src={TopRight} />
              </div>
              <div
                ...
                id="Box2"
              >
                <h1 className="py-4 text-box-heading " aria-label="Top-Left">
                  Top Left{' '}
                </h1>
                <img src={TopRight} />
              </div>
              ...
              <div
                ...
                id="Box4"
              >
                <h1 className="py-4 text-box-heading" aria-label="Bottom-Left">
                  Bottom Left{' '}
                </h1>
                <img src={TopRight} />
              </div>
